...
int main(int argc, char *argv[])
{
   ...
   // 2D histograms
   TH2D h2_BeforeMatching_Theta("h2_BeforeMatching_Theta", "h2_BeforeMatching_Theta", 2 * BinCount, 0, 2 * BinCount,  BinCount, EnergyBins);
   TH2D h2_BeforeMatching_Z("h2_BeforeMatching_Z", "h2_BeforeMatching_Z", 2 * BinCount, 0, 2 * BinCount,  BinCount, EnergyBins);
   TH2D h2_Matching_Theta("h2_Matching_Theta", "h2_Matching_Theta", 2 * BinCount, 0, 2 * BinCount,  BinCount, EnergyBins);
   TH2D h2_Matching_Z("h2_Matching_Z", "h2_Matching_Z", 2 * BinCount, 0, 2 * BinCount,  BinCount, EnergyBins);
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      for (int iPair = 0; iPair < *Matched_NPair; iPair++) 
      {
         ...
         int BinEnergyGen = FindBin(Matched_E1E2Gen[iPair], BinCount, EnergyBins);
   ...
   for(int iE = 0; iE < EntryCountBefore; iE++)
   {
      ...
      for (int iPair = 0; iPair < *NUnmatchedPair; iPair++) 
      {
         ...
         int BinEnergyGen = FindBin(E1E2GenUnmatched[iPair]/(TotalE*TotalE), BinCount, EnergyBins);
