...
int main(int argc, char *argv[])
{
  ...
  Int_t nEv=smeared->GetEntries();
   ...
   TGraphAsymmErrors theory = getTheoryPlot(); 
   MakeCanvasZTheory(histsTheory,GzDataSyst, theory, {"Fully Corrected Data"}, Form("plot/CorrectedData_z_theory"), "#it{z} = (1- cos(#theta))/2", "#frac{1}{#it{N}_{event}}#frac{d(Sum E_{i}E_{j}/E^{2})}{d#it{z}}",1e-3,1e3, false, true);
